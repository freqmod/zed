...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            editor_jump_marker: neutral().light().step_1(),
            editor_jump_marker_first: neutral().light().step_5(),
            editor_jump_marker_entered: cyan().light().step_10(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            editor_jump_marker: neutral().dark_alpha().step_8(),
            editor_jump_marker_first: neutral().dark_alpha().step_12(),
            editor_jump_marker_entered: cyan().dark_alpha().step_10(),
